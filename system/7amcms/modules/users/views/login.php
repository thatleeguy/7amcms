	...
	<fieldset>
	    ...
	    <?php endif;?>
				<div>
						...
						<a href="#" class="yellow-btn" onclick="var forms = document.getElementsByTagName('FORM'); for (var i=0; i<forms.length; i++) forms[i].submit();" style="float: right; margin-right: 30px"><span>&nbsp;&nbsp;<?php echo lang('login:login') ?>&nbsp;&nbsp;</span></a>
				</div>
	</fieldset>
	<?php echo form_close();?>
</div>
