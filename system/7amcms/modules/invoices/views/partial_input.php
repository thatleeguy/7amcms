...
$due_date_input = isset($due_date_input) ? $due_date_input : '';
...
<div class="partial-inputs">
    ...
    <div class="partial-percentage"><?php echo form_dropdown('partial-is_percentage['.$key.']', array(Currency::symbol(), '%'), set_value('partial-is_percentage['.$key.']', $is_percentage), 'id="partial-percentage'.$id.'"'); ?></div>
