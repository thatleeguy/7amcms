<div class="invoice-block">
	...
	<?php if ($invoices): ?>
	<ul class="btns-list">
		<li><a href="<?php echo site_url('admin/invoices/create_estimate'); ?>" title="<?php echo lang('estimates:createnew') ?>" class="yellow-btn"><span><?php echo lang('estimates:createnew') ?></span></a></li>
	</ul><!-- /btns-list end -->
	<?php endif; ?>
	<br style="clear: both;" />
	<div class="head-box">
...
<p class="call_to_action"><a href="<?php echo site_url('admin/invoices/create_estimate'); ?>" class="yellow-btn"><span><?php echo lang('estimates:createnew') ?></span></a></p>
