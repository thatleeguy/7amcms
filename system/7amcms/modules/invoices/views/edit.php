...
<div class="invoice-block">
	<div class="head-box">
		<h3 class="ttl ttl3">Edit Invoice #<?php echo $invoice->invoice_number; ?></h3>
	</div><!-- /head-box end -->
		...
		<?php echo form_open_multipart('admin/invoices/edit/'.$invoice->unique_id, 'id="create-invoice"'); ?>
			<fieldset>
				...
				<div class="row">
					...
					<div class="sel-item">
						<?php echo form_dropdown('is_recurring', array('No', 'Yes'), set_value('is_recurring', $invoice->is_recurring), 'id="is_recurring"'); ?>
					</div>
				</div>
				...
				<div id="recurring-options" style="display:none">
					...
					<div class="row">
						...
						<div class="sel-item">
							<?php echo form_dropdown('frequency', array('w' => 'Week', 'm' => 'Month', 'y' => 'Year'), set_value('frequency', $invoice->frequency), 'id="frequency"'); ?>
						</div>
					</div>
				...
				<div id="SIMPLE-wrapper" class="type-wrapper row">
   				...
   				<div class="gateway-items row">
	                <?php $this->load->view('invoices/partial_input_container', array('action' => 'edit', 'parts' => isset($invoice->partial_payments[1]) ? $invoice->partial_payments : array('key' => 1))); ?>
				...
				<div class="row">
					...
					<a href="#" class="yellow-btn" onclick="$('#create-invoice').submit();"><span><?php echo __('invoices:saveinvoice'); ?>&rarr;</span></a>
				</div>
			</fieldset>
