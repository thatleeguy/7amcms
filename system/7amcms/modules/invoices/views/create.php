		...
		<fieldset>
			...
			<div id="invoice-type-block" class="row">
				...
				<div class="check-holder">
					...
					echo form_radio(array(
						...
						'id' => 'type-simple',
						'value' => 'SIMPLE',
						'checked' => set_radio('type', 'SIMPLE', TRUE)
					));
					?>
				...
				<div class="check-holder">
					...
					echo form_radio(array(
						...
						'id' => 'type-detailed',
						'value' => 'DETAILED',
						'checked' => set_radio('type', 'DETAILED') OR isset($project)
					));
					?>
			...
			<div id="recurring-options" style="display:none">
				...
				<div class="row">
					...
					<label for="send_x_days_before">Send</label>
						<?php echo form_input('send_x_days_before', set_value('send_x_days_before', 7), 'id="send_x_days_before" class="text txt"'); ?>
			...
			<div id="DETAILED-wrapper" class="type-wrapper row">
				...
				<div class="row">
					...
					<a href="#" class="yellow-btn" onclick="$('#create-invoice').submit(); return false;"><span><?php echo (!isset($iframe) or !$iframe) ? __('invoices:newinvoice') : __('global:saveandinsert') ?> &rarr;</span></a>
				</div>
			</fieldset>
