	...
	<?php echo form_open('admin/proposals/send/'.$unique_id, 'id="send-proposal"'); ?>
		...
		<fieldset>
			...
			<p>Fill out the form below and we'll deliver this proposal for you.</p>
				...
				<h4>To: <span><?php echo $proposal['client']->email;?></span></h4>
		    </div>
			<div class="row base-indent">
				<label for="subject"><?php echo __('global:subject') ?>: </label><input type="text" id="subject" name="subject" class="txt" value="Proposal #<?php echo $proposal['proposal_number'];?> - <?php echo $proposal['title'];?>">
			</div>
			<div class="row base-indent">
