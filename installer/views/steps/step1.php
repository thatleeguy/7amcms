<h2>Step 1: Making sure we have enough pans.</h2>
<table cellspacing="0" class="listtable">
	...
	<tr>
		...
		<td>The system/pancake/config file must be writable.</td>
	</tr>
	<tr>
...
<?php if ($can_continue): ?>
	<p class="center"><a href="<?php echo site_url('wizard/step2'); ?>" class="button">Step 2: Start Mixing</a></p>
<?php else: ?>
