...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en">
	...
	<?php endif; ?>
        ...
        <script>
            ...
            proposalGetEstimates = '<?php echo site_url('ajax/get_estimates/'.$proposal['client_id']);?>';
        ...
        <script>window.jQuery || document.write('<script src="<?php echo asset::get_src('jquery-1.6.2.min.js', 'js');?>">\x3C/script>')</script>
	...
	<div id="buttonBar" data-status="<?php echo $proposal['status'];?>" >
		...
		<?php if (is_admin()): ?>
                    ...
                    <?php echo anchor('proposal/'.$proposal['unique_id'].'/pdf', __('global:downloadpdf'), 'class=""'); ?>
